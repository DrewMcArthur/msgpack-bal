...
TestCase[] float32TestCase = [{"input": 1.5, "output": [0xca, 0x3f, 0xc0, 0x00, 0x00]}];
TestCase[] float64TestCase = [{"input": 10000000000000000.0001, "output": [0xcb, 0x43, 0x41, 0xC3, 0x79, 0x37, 0xE0, 0x80, 0x00]}];

TestCase[][] floatTestCases = [
    float32TestCase,
    float64TestCase
];
